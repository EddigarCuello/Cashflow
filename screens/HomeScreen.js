...
const transactions = [
    { id: '2', name: 'Income', amount: '$3000', color: '#0FA958', icon: 'arrow-up-circle' },
    { id: '3', name: 'Bills', amount: '-$800', color: '#E55B42', icon: 'receipt' },
    { id: '4', name: 'Income', amount: '$3000', color: '#0FA958', icon: 'arrow-up-circle' },
    { id: '5', name: 'Bills', amount: '-$800', color: '#E55B42', icon: 'receipt' },
    { id: '6', name: 'Income', amount: '$3000', color: '#0FA958', icon: 'arrow-up-circle' },
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.menuContainer}>
                ...
                >
                    <Ionicons name={showMoreOptions ? "close" : "ellipsis-horizontal"} size={24} color="#E5A442" />
            ...
            <View style={styles.transactionContainer}> 
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={[styles.transactionItem, { borderLeftColor: item.color }]}>                        
            ...
            <View style={styles.pagination}>
                ...
                >
                    <Ionicons name="home-outline" size={24} color={activeIndex === 0 ? "#FFF" : "#B0B0B0"} />
                </TouchableOpacity>
                <TouchableOpacity 
                    style={[styles.button, activeIndex === 1 && styles.activeButton]} 
                    onPress={() => setActiveIndex(1)}
                >
                    <Ionicons name="person-outline" size={24} color={activeIndex === 1 ? "#FFF" : "#B0B0B0"} />
                </TouchableOpacity>
            </View>
        </View>
    );
...
const styles = StyleSheet.create({
    ...
    header: { 
        position: 'relative', height: 250, padding: 0, borderRadius: 20, 
        alignItems: 'center', justifyContent: 'center', marginBottom: 20, overflow: 'hidden' 
    },
    backgroundImage: { position: 'absolute', width: '100%', height: '100%', borderRadius: 15, opacity: 0.5 },
    ...
    transactionTitle: { color: '#FFF', fontSize: 20, fontWeight: 'bold', marginVertical: 10 },
    transactionItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 15, backgroundColor: '#2A2D3E', borderRadius: 10, marginVertical: 5, borderLeftWidth: 5 },
    icon: { marginRight: 10 },
